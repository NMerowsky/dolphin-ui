...
if($p == "experiments"){
	...
	$data = "This table represents all of the Imports you have access to viewing.
			...
			are supplies on sample imports.  The status can be 1 of 6 colors: grey means the backup is pending, red stands for an amazon checksum mismatch,
			...
			yellow means the file is currently being uploaded, and green means the upload is current.
			<br><br>
